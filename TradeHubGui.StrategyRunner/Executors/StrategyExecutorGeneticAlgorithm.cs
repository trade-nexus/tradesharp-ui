...
namespace TradeHubGui.StrategyRunner.Executors
{
    ...
    /// </summary>
    internal class StrategyExecutorGeneticAlgorithm : IStrategyExecutor
    {
        private readonly Type _type = typeof (StrategyExecutorGeneticAlgorithm);
        ...
        public StrategyExecutorGeneticAlgorithm(Type strategyType, object[] ctorArguments)
        {
        ...
        {
            // Bars first needs to be provided to 'Order Executor' before sending it out to Strategy
