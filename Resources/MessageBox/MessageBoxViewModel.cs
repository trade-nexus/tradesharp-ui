        ...
        private void SetImageSource(MessageBoxImage image)
        {
            switch (image)
            {
                ...
                case MessageBoxImage.Error:
                    MessageImageSource = Application.Current.Resources["imgError"] as DrawingImage;
                    break;

                //case MessageBoxImage.Exclamation:
                case MessageBoxImage.Warning:
                    MessageImageSource = Application.Current.Resources["imgWarning"] as DrawingImage;
                    break;

                case MessageBoxImage.Question:
                    MessageImageSource = Application.Current.Resources["imgQuestion"] as DrawingImage;
                    break;

                //case MessageBoxImage.Asterisk:
                case MessageBoxImage.Information:
                    MessageImageSource = Application.Current.Resources["imgInformation"] as DrawingImage;
                    break;
